          ...
          <ul class="navbar-nav">
            ...
            if($userLoggedIn!=null){
                 echo '
                    ...
                    <li class="nav-item">
                      <a class="nav-link js-scroll active" href="virusadd.php">ADD Virus</a>
                    </li>
    ...
    <div class="intro intro-single route bg-image" style="background-image: url(assets/img/overlay-bg.jpg)">
      ...
      <div class="intro-content display-table">
        <div class="table-cell">
          <div class="container">
            <h2 class="intro-title mb-4">ADD VIRUS</h2>
            <ol class="breadcrumb d-flex justify-content-center">
              <li class="breadcrumb-item">
                <a href="index.php">Home</a>
              </li>
              <li class="breadcrumb-item active">ADD VIRUS</li>
            </ol>
          </div>
        </div>
      </div>
                        ...
                        <div class="row">
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                              <input type="text" name="name" class="form-control" id="name" placeholder="Enter Virus Name"  />

                            </div>
                          </div>
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                              <input type="text" class="form-control" name="category" id="email" placeholder="Enter Virus Category" />

                            </div>
                          </div>
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                              <input type="text" class="form-control" name="family" id="family" placeholder="Enter virus family"  />

                            </div>
                          </div>
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                              <input type="text" class="form-control" name="vaccine" id="phone" placeholder="Enter virus vaccine status"  />
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <textarea class="form-control" name="bio" rows="5" placeholder="Write virus descripsion here"></textarea>
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                  <input type="file" name="VirusImage" class="custom-file-input" id="file" lang="es">
                            ...
                            <div class="form-group">
                             ...
                             <button type="submit" name="save_virus" class="button button-a button-big button-rouded">Add Virus</button>
                            </div>     
